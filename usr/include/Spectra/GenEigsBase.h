...
private:
    ...
    void retrieve_ritzpair()
    {
        ...
        SortEigenvalue<Complex, SelectionRule> sorting(evals.data(), (int)evals.size());
...
protected:
    ...
    virtual void sort_ritzpair(int sort_rule)
    {
        ...
        SortEigenvalue<Complex, LARGEST_MAGN> sorting(m_ritz_val.data(), (int)m_nev);
        std::vector<int> ind = sorting.index();
        ...
        switch(sort_rule)
        {
            ...
            case LARGEST_REAL:
            {
                SortEigenvalue<Complex, LARGEST_REAL> sorting(m_ritz_val.data(), (int)m_nev);
                ind = sorting.index();
            }
                break;
            case LARGEST_IMAG:
            {
                SortEigenvalue<Complex, LARGEST_IMAG> sorting(m_ritz_val.data(), (int)m_nev);
                ind = sorting.index();
            }
                break;
            case SMALLEST_MAGN:
            {
                SortEigenvalue<Complex, SMALLEST_MAGN> sorting(m_ritz_val.data(), (int)m_nev);
                ind = sorting.index();
            }
                break;
            case SMALLEST_REAL:
            {
                SortEigenvalue<Complex, SMALLEST_REAL> sorting(m_ritz_val.data(), (int)m_nev);
                ind = sorting.index();
            }
                break;
            case SMALLEST_IMAG:
            {
                SortEigenvalue<Complex, SMALLEST_IMAG> sorting(m_ritz_val.data(), (int)m_nev);
                ind = sorting.index();
            }
                break;
            default:
