...
#define NEXT(E)	(E)->m_pNext
#define PREV(E)	(E)->m_pNext->m_pNext
#define MATE(E)	(E)->m_pMate
...
// 키(VK_SHIFT, VK_CTRL, VK_MENU)가 눌렸는지 판단하는 매크로
#define ISPRESSED(Key)	(GetAsyncKeyState(Key) & 0x8000)
